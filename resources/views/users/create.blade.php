...
>
    ...
    @php
        $currentRole = isset($user) ? $user->getRoleNames()->first() : old('role');
    @endphp
    ...
    >
        ...
        <option value="pegawai" {{ $currentRole == 'pegawai' ? 'selected' : '' }}>
            Pegawai
        </option>
        <option value="mahasiswa" {{ $currentRole == 'mahasiswa' ? 'selected' : '' }}>
            Mahasiswa
        </option>
    </select>
    @error('role') 
